...
var Spinner = function Spinner(props) {
  ...
  var loaderStyles1 = tslib.__assign(tslib.__assign({}, commonStyles), {
    size: size ? size : 15,
    sizeUnit: sizeUnit ? sizeUnit : 'px'
  });

  var loaderStyles2 = tslib.__assign(tslib.__assign({}, commonStyles), {
    width: size ? size[0] : 5,
  ...
  switch (type) {
    case 'BarLoader':
      return React__default.createElement(Spinners.BarLoader, tslib.__assign({}, loaderStyles2));

    case 'BeatLoader':
      return React__default.createElement(Spinners.BeatLoader, tslib.__assign({}, loaderStyles1));

    case 'BounceLoader':
      return React__default.createElement(Spinners.BounceLoader, tslib.__assign({}, loaderStyles1));

    case 'ClimbingBoxLoader':
      return React__default.createElement(Spinners.ClimbingBoxLoader, tslib.__assign({}, loaderStyles1));

    case 'ClipLoader':
      return React__default.createElement(Spinners.ClipLoader, tslib.__assign({}, loaderStyles1));

    case 'DotLoader':
      return React__default.createElement(Spinners.DotLoader, tslib.__assign({}, loaderStyles1));

    case 'FadeLoader':
      return React__default.createElement(Spinners.FadeLoader, tslib.__assign({}, loaderStyles2));

    case 'PulseLoader':
      return React__default.createElement(Spinners.PulseLoader, tslib.__assign({}, loaderStyles1));

    case 'RotateLoader':
      return React__default.createElement(Spinners.RotateLoader, tslib.__assign({}, loaderStyles1));

    case 'ScaleLoader':
      return React__default.createElement(Spinners.ScaleLoader, tslib.__assign({}, loaderStyles2));

    case 'SyncLoader':
      return React__default.createElement(Spinners.SyncLoader, tslib.__assign({}, loaderStyles1));
...
/*#__PURE__*/
function (_super) {
  tslib.__extends(BarGraph, _super);
...
/*#__PURE__*/
function (_super) {
  tslib.__extends(LineGraph, _super);
...
/*#__PURE__*/
function (_super) {
  tslib.__extends(PieGraph, _super);
...
var Image = function Image(props) {
  var circle = props.circle,
      ...
      src = props.src,
      imgAttributes = tslib.__rest(props, ["circle", "fluid", "rounded", "src"]);

  return React__default.createElement(BootstrapImage, tslib.__assign({
    fluid: fluid,
    rounded: rounded,
...
var Panel = function Panel(props) {
  ...
  var _a = React.useState(!collapsed || !collapsible),
      open = _a[0],
      setOpen = _a[1];
...
var Modal = function Modal(props) {
  ...
  }, closeButton && React__default.createElement(Button, tslib.__assign({}, closeButton, {
    color: closeButton.color || 'secondary'
  }), closeButton.children || 'Close'), middleButton && React__default.createElement(Button, tslib.__assign({}, middleButton, {
    color: middleButton.color || 'info'
  }), middleButton.children || 'Retry'), successButton && React__default.createElement(Button, tslib.__assign({}, successButton, {
